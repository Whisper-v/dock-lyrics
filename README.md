...
- **🎨 颜色主题**：7 套预设（跟随系统 / 柠檬黄 / 苹果青 / 冰川蓝 / 霓虹紫 / 樱花粉 / 暖阳橙），
  文字与均衡器音柱同步换色，选择持久化到 `~/.config/deepin/dock-lyrics.conf`。
...
4. **右键歌词条**可唤出快捷菜单：切换播放状态、上下曲、更换**颜色主题**（7 套预设，即时生效并记忆）、
   或手动**刷新歌词**；菜单内还会标注当前歌词来自本地文件、网易云还是 LRCLIB。
